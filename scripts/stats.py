...
def analyze(path):
    jp = sentences(path)        # source lines: a sentence, or a whole quoted turn
    sn = prose_sentences(jp)    # the sentences inside them, for the rhythm measures
    pg = pages(path)
